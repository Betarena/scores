...
<script lang="ts">
  ...
  export let
    ...
    /**
     * @description
     * (var.) navigation target default key name
     */
    navKey: string,
    /**
     * @description
     * (var.) navigation target `url`
     */
    navUrl: string,
    /**
     * @description
     * (var.) **translation** of target `navigation` text
     */
    navTxt: string,
    /**
     * @description
     * (var.) **translation** of target `soon` text
     */
    soonTxt: string = 'soon',
    /**
     * @description
     * (var.) **translation** of target `new` text
     */
    newTxt: string = 'new',
    /**
     * @description
     * (var.) wether target navigation is `BETA` and/or coming soon
     */
    isSoon: boolean = false,
    /**
     * @description
     * (var.) wether target navigation is `NEW`
     */
    isNew: boolean = false,
    /**
     * @description
...
<div
  ...
  cursor-pointer
  "
  class:m-b-30={VIEWPORT_TABLET_INIT[1] || VIEWPORT_MOBILE_INIT[1]}
  class:active={if_R_0}
