...
<script lang="ts">
  ...
  import { routeIdPageProfile, routeIdPageProfileAuthorCreate } from "$lib/constants/paths.js";
...
<footer
  ...
  class:border={[routeIdPageProfile, routeIdPageProfileAuthorCreate].includes($page.route.id || "")}
>
  <div class="wrapper">
