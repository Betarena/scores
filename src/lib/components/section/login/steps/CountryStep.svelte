...
<div class="country-step {viewportType}">
  ...
  <Container hFull={false}>
    <div class="form">
      ...
      <div class="form-body">
        <DropDownInput searchable={true} bind:value label={translations.country || "Country"}  options={country} placeholder={translations.search_country || "Select your country"} infoText={translations.customise_feed || "Select your country to customise your feed"}>
