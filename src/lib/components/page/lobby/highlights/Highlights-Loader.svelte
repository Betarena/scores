...
<script lang="ts">
  ...
  const
    ...
    */
    CNAME = 'competition⮕w⮕highlights-loader'
  ;
...
<style>
  ...
  div#competition⮕w⮕highlights-loader⮕top-row
  {
    /* 🎨 style */
    min-height: 64px;
		padding: 16px 24px;
  ...
  div#competition⮕w⮕highlights-loader⮕middle-section
  {
    /* 🎨 style */
    padding: 20px 24px;
  }
  ...
  div#competition⮕w⮕highlights-loader⮕bottom-row
  {
    /* 🎨 style */
    min-height: 72px;
		padding: 16px 24px;
