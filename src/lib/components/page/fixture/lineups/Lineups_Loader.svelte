...
<style>
	...
	/* plyaer row box */
	div#fixture-lineups-loader
		div#loader-player-box
		div.loader-player-row:first-child {
	...
	div#fixture-lineups-loader
		div#loader-player-box
		div.loader-player-row {
		padding: 8px 0;
	}
	div#fixture-lineups-loader
		div#loader-player-box
		div.loader-player-row:last-child {
		padding: 8px 0 0 0;
	}
  ...
  ==================== */
	...
	div#fixture-lineups-loader.dark-background-1
		div#loader-player-box
		div.loader-player-row:first-child {
