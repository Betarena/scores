...
<script lang="ts">
  ...
  import type {
    B_LEGT_D,
    B_LEGT_T,
  } from "@betarena/scores-lib/types/leagues-table.js";
  ...
  export let B_LEGT_T: B_LEGT_T, B_LEGT_D: B_LEGT_D;
  ...
  let // ◼️ IMPORTANT
    ...
    dropdownSelect: string =
      B_LEGT_D?.top_leagues_table_data?.[0]?.season_league_id ?? null,
  ...
  onMount(async () => {
    [isViewTablet, isViewMobile] = viewport_change(
...
<div>
  ...
  -->
  {#if !noWidgetData}
    <WidgetTitle WIDGET_TITLE={B_LEGT_T?.translations?.title} />
      ...
      >
        ...
        {#if toggleDropdown}
          <div id="more-top-leagues-outer">
            <div id="more-top-leagues-list-container">
