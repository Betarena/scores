  ...
  $: FIXTURES_ODDS_T = $page.data?.FIXTURES_ODDS_T
	...
	async function widgetInit(): Promise<Cache_Single_Tournaments_League_Info_Data_Response> {
      ...
      dlog(`${LI_W_T_TAG} ❌ no data available!`, LI_W_T_TOG, LI_W_T_STY);
		...
		LEAGUE_INFO_SEO_DATA.data.sportbook_detail =
			response;
		...
		LEAGUE_INFO_SEO_DATA.data.seasons.sort(
			(a, b) =>
	...
	function validateSeasonProgressDate(
      ...
      FIXTURES_ODDS_T
		...
		if (
			...
			const seasonDiffDays = Math.floor(
			...
			datePercentageDiff =
				100 -
				(currentDiffDays / seasonDiffDays) * 100;
  ...
  -->
    ...
    -->
      ...
      -->
          ...
          -->
					<div class="row-space-out-top m-b-40">
            ...
            -->
              ...
              -->
							<div class="row-space-end m-b-15">
