...
// eslint-disable-next-line @typescript-eslint/no-empty-interface
export interface REDIS_CACHE_SINGLE_scoreboard_data
	extends Fixture_Scoreboard_Info {
	// empty
}
...
export interface BETARENA_HASURA_SURGICAL_JSONB_scores_football_leagues
	extends BETARENA_HASURA_scores_football_leagues {
	image_path_j?: string;
}
