...
export interface REDIS_CACHE_SINGLE_statistics_translation extends FixtureStatsTranslations, WidgetsNoDataAvailable {
  lang?: string
}

// eslint-disable-next-line @typescript-eslint/no-empty-interface
export interface REDIS_CACHE_SINGLE_statistics_data extends Fixture_Statistics {
  // empty
}
