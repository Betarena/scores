...
export interface REDIS_CACHE_SINGLE_about_translation extends FixtureAboutTranslations, WidgetsNoDataAvailable {
  lang?: string
}

// eslint-disable-next-line @typescript-eslint/no-empty-interface
export interface REDIS_CACHE_SINGLE_about_data extends Fixture_About {
  // empty
}
...
export interface Fixture_About extends BETARENA_HASURA_historic_fixtures {
  // empty
  seo_data?: string;
}