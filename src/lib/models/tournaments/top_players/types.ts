...
export interface REDIS_CACHE_SINGLE_tournaments_top_player_widget_t_data_response
...
export interface REDIS_CACHE_SINGLE_tournaments_top_player_widget_t_data_response
	extends BETARENA_HASURA_player_positions_translations {}
