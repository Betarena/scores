...
import { routeIdAuthorProfile, routeIdContent, routeIdPageAuthors, routeIdPageCompetitions, routeIdPageProfile, routeIdPageTags, routeIdSportstack } from '$lib/constants/paths.js';
        ...
        ): void =>
        {
          for (const iterator of data)
          {
            ...
            else if (dataTarget == 'routeId')
            {
              ...
              else if ([routeIdPageAuthors, routeIdPageTags, routeIdContent, routeIdAuthorProfile, routeIdSportstack].includes(dataPoint))
