 ...
 */
export const REDIS_CACHE_FIXTURE_STATISTICS_DATA_0 = gql`
	query REDIS_CACHE_FIXTURE_STATISTICS_DATA_0
	@cached(ttl: 300) {
 ...
 * [ℹ] _0 dependent
 */
export const REDIS_CACHE_FIXTURE_STATISTICS_DATA_1 = gql`
	query REDIS_CACHE_FIXTURE_STATISTICS_DATA_1(
		$limit: Int
		$offset: Int
		$seasonIds: [Int!]
	) @cached(ttl: 300) {
 ...
 * [ℹ] TRANSLATION
 */
export const REDIS_CACHE_FIXTURE_STATISTICS_DATA_3 = gql`
	query REDIS_CACHE_FIXTURE_STATISTICS_DATA_3
	@cached(ttl: 300) {
 ...
 */
export const REDIS_CACHE_FIXTURE_STATISTICS_DATA_4 = gql`
	query REDIS_CACHE_FIXTURE_STATISTICS_DATA_3(
		$fixture_id: Int!
	) @cached(ttl: 300) {
		historic_fixtures(
