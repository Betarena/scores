...
import type { BETARENA_HASURA_auth_query, REDIS_CACHE_SINGLE_auth_translation } from '$lib/models/_main_/auth/types';
...
async function get_auth_translation (
  lang: string
	...
	const response: BETARENA_HASURA_auth_query = await initGrapQLClient().request(
