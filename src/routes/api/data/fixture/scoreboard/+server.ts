...
import { FSCOR_FP_ENTRY, FSCOR_FP_ENTRY_1 } from '@betarena/scores-lib/dist/functions/func.fixture.scoreboard.js';
...
{
  const dataRes0 = await FSCOR_FP_ENTRY
  (
    [fixtureId]
  )
...
{
  const dataRes0 = await FSCOR_FP_ENTRY_1
  (
    [lang]
  );
