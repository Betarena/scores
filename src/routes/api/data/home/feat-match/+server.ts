...
import { HFEATM_HP_ENTRY, HFEATM_HP_ENTRY_1 } from '@betarena/scores-lib/dist/functions/func.feat-match.js';
import { FEATM_C_D_A, FEATM_C_T_A } from '@betarena/scores-lib/dist/redis/config.js';
 ...
 * [FALLBACK]
 * @description
 * ➨ featured match (widget) hasura DATA fetch;
 * @param 
 * {string} geoPos
 * @returns 
 * Promise < B_FEATM_D >
 ...
 * [FALLBACK]
 * @description
 * ➨ featured match (widget) hasura TRANSLATION fetch;
 * @param 
 * {string} lang
 * @returns 
 * Promise < B_FEATM_T >
...
{
  const dataRes0 = await HFEATM_HP_ENTRY_1
  (
    graphQlInstance,
    [lang]
  );
