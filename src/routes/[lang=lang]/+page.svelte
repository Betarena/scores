...
<section id="home-page">
	...
	{#if !tabletExclusive && !mobileExclusive}
		...
		<div>
			...
			<svelte:component
				this={LeagueListWidget}
				{LEAGUE_LIST_WIDGET_DATA_SEO}
				{LEAGUE_LIST_WIDGET_DATA}
			/>
		</div>
		<!-- [ℹ] 2nd ROW -->
		...
		<div class="grid-display-column">
			...
			<svelte:component
				this={FeaturedMatchWidget}
				{FEATURED_MATCH_WIDGET_DATA_SEO}
				{FEATURED_MATCH_WIDGET_DATA_MAIN}
			/>
			<!-- [ℹ] widget #2 -->
			<!-- <FeaturedBettingSitesWidget {FEATURED_BETTING_SITES_WIDGET_DATA_SEO} /> -->
			<svelte:component
				this={FeaturedBettingSitesWidget}
				{FEATURED_BETTING_SITES_WIDGET_DATA_SEO}
				{FEATURED_BETTING_SITES_WIDGET_DATA}
			/>
			<!-- [ℹ] widget #3 -->
			<!-- <BestGoalscorersWidget {BEST_GOAL_SCORERS_DATA_SEO} /> -->
			<svelte:component
				this={BestGoalscorersWidget}
				{BEST_GOAL_SCORERS_DATA_SEO}
				{BEST_GOAL_SCORERS_DATA}
			/>
			<!-- [ℹ] widget #4 -->
			<!-- <LeaguesTableWidget {LEAGUES_TABLE_SCORES_SEO_DATA} /> -->
			<svelte:component
				this={LeaguesTableWidget}
				{LEAGUES_TABLE_SCORES_SEO_DATA}
				{LEAGUES_TABLE_SCORES_DATA}
			/>
		</div>
		<!-- [ℹ] MOBILE VIEW ONLY -->
	{:else}
...
<style>
  ...
  RESPONSIVE FOR DESKTOP ONLY (&+) [1440px] */
	@media only screen and (min-width: 1160px) {
		section#home-page {
			gap: 20px;
			grid-template-columns: minmax(auto, 275px) minmax(
					auto,
					502px
				) minmax(auto, 502px);
		}
