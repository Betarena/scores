...
export async function load({
  ...
  */
	...
	const response_featured_betting_sites_seo =
		data[2];
	...
	const response_livescores_football_leagues =
		data[9];
	const response_livescores_football_translations =
		data[10];
	const response_livescores_football_tournaments =
		data[11];
	...
	// [🐞]
	if (response_homepage_seo == undefined)
		console.log(
			'response_homepage_seo is undefined'
		);
	if (response_featured_match_seo == undefined)
		console.log(
			'response_featured_match_seo is undefined'
		);
	if (
		...
		console.log(
			'response_featured_betting_sites_seo is undefined'
		);
	if (response_best_goalscorers_seo == undefined)
		console.log(
			'response_best_goalscorers_seo is undefined'
		);
	if (response_league_list_seo == undefined)
		console.log(
			'response_league_list_seo is undefined'
		);
	if (response_leagues_table_seo == undefined)
		console.log(
			'response_leagues_table_seo is undefined'
		);
	if (response_seo_block_seo == undefined)
		console.log(
			'response_seo_block_seo is undefined'
		);
	if (response_livescores_football == undefined)
		console.log(
			'response_livescores_football is undefined'
		);
	if (
		...
		console.log(
			'response_livescores_football_leagues is undefined'
		);
	if (
		...
		console.log(
			'response_livescores_football_translations is undefined'
		);
	if (
		...
		console.log(
			'response_livescores_football_tournaments is undefined'
		);
	...
	throw error(
		500,
		`Uh-oh! There has been an /{lang} page preloading error`
	);
}
